...
const colorClasses = {
  linkedin: "bg-[#0A66C2] text-white hover:bg-[#004182] shadow-md shadow-[#0A66C2]/30",
  facebook: "bg-[#1877F2] text-white hover:bg-[#0d65d9] shadow-md shadow-[#1877F2]/30",
};

export function SocialLinks({ size = "md", className = "" }: SocialLinksProps) {
  return (
    <ul className={`flex flex-wrap items-center gap-3 ${className}`} aria-label="Social media">
